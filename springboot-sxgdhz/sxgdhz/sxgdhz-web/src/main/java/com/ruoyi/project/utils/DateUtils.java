...
public class DateUtils {
    ...
    public static final String DATE_FORMAT_DATETIME16 = "yyyy-MM-dd HH:mm";
    ...
    public static LocalDateTime parseLocalDateTime16(String str) throws ParseException {
        return LocalDateTime.parse(str, DateTimeFormatter.ofPattern(DATE_FORMAT_DATETIME));
    }
    ...
    public static String formatDate(LocalDate date) {
        LocalDateTime localDateTime = LocalDateTime.of(date, LocalTime.of(0, 0, 0));
        return localDateTime.format(DateTimeFormatter.ofPattern(SHORTDATEFORMAT));
    }
